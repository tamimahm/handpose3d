...
for keys in set_key:
    ...
    feature_data=np.zeros([n_d,238,2])
    feature_test=np.zeros([n_t,238,2])
    feature_data[:,:,0]=data[:,:]
    for i in range(n_d):
        #feature_data[i,:,1]=data_label[i]
        # feature_data[i,:,1]=hand_train[i]
        feature_data[i,:,1]=task_id_train[i]
    feature_test[:,:,0]=test_data[:,:]
    for i in range(n_t):
        #feature_test[i,:,1]=test_label[i]
        # feature_test[i,:,1]=hand_test[i]
        feature_test[i,:,1]=task_id_test[i]
    ...
    root="D:/Chicago_study/impute/model_feature_"
    ...
    imputation = brits.impute(test_dataset)
